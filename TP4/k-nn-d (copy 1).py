...
def correr_hasta(nombreDatos,max_dist, step):
    ...
    for n in step_list:
        ...
        #rint("Genere: "+nombreDatos+".predic", nombreDatos+"-"+str(n)+".predic")
        #print(output)
